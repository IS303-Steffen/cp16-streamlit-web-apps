...
if st.session_state["current_view"] == 'main_menu':
    ...
    if add_movie:
        ...
        st.session_state['current_view'] = "add_movie"
        st.rerun()
        ...
        st.session_state['current_view'] = "update_watchlist"
        st.rerun()
...
elif st.session_state["current_view"] == 'add_movie':
...
elif st.session_state["current_view"] == 'update_watchlist':
